...
<head>
    ...
    <title>Engine Gallery • Conferma eliminazione articolo</title>
        ...
        <div class="col-lg-8">
            <div class="card shadow-sm border-danger">
                <div class="card-body p-4 p-md-5">
                    ...
                    <p class="mb-1">Sei veramente sicuro di voler eliminare questo articolo?</p>
                    <p class="mb-4 fw-semibold">${item.name}</p>
                    ...
                    <div class="d-flex flex-wrap gap-2">
                        ...
                        <form action="<%= request.getContextPath() %>/warehouse/delete" method="post" class="m-0">
