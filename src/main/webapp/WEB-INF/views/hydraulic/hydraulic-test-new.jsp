    ...
    <div class="card-base" style="max-width: 620px; width: 100%;">
        ...
        <form action="<%= request.getContextPath() %>/hydraulic-test/new"
            ...
            <div class="mb-3">
                ...
                <div class="small text-muted mt-1">L'eventuale ottimizzazione del video avviene dopo l'upload, senza alterare l'anteprima locale.</div>
                ...
                <div id="videoPreviewWrap" class="selected-video-preview-wrap mt-2 d-none">
                    <video id="videoPreview" class="selected-video-preview" controls playsinline preload="metadata"></video>
                </div>
            </div>
...
<script>
    (() => {
        ...
        const showPreviewFile = (file) => {
            ...
            setStatus('Video pronto per upload.', 'text-success');
        };
        ...
        window.addEventListener('pagehide', cleanupPreviewObjectUrl);
    })();
</script>
